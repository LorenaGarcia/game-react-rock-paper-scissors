        ...
        <div className="options">
          ...
          >
            <img
              alt="scissors"
              className="image-button"
              src={`${process.env.PUBLIC_URL}/images/scissors_2.png`}
            />
          </button>
        </div>
            ...
            <div className="match" key={key}>
              <div className="div1">
                <img
                  ...
                  src={`${process.env.PUBLIC_URL}/images/mini-${val.user}.png`}
                />
              </div>
              <div className="div2">
                <div />
              ...
              <div className="div3">
                <img
                  alt={`mini-${val.computer}`}
                  className="image-timeline"
                  src={`${process.env.PUBLIC_URL}/images/mini-${
                    val.computer
                  }.png`}
                />
              </div>
